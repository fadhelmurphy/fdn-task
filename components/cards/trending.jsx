...
export const TrendingCards = ({data=Array.from(Array(4).keys())}) => {
  ...
  const RevCard = () => (
    <Card className="border-0 p-3" style={{ borderRadius:"10px" }}> 
  ...
  return (
    ...
    `}</style>
      <Slider className="trending-slider" ref={(c) => (sliderOnClick = c)} {...settings}>
        <div>
          <RevCard />
        </div>
        <div>
